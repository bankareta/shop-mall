...
@section('banner')
    <div class="container-fluid page-header py-5">
        ...
        <ol class="breadcrumb justify-content-center mb-0">
            ...
            <li class="breadcrumb-item active text-white">Detail Product</li>
        </ol>
    </div>
@endsection
@section('content')
            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <h4 class="fw-bold mb-3">{{ $record->name }}</h4>
                            <p class="mb-3">Category: {{ $record->category->name }}</p>
                            <h5 class="fw-bold mb-3">Rp {{ number_format($record->price, 0, ',', '.') }}</h5>
                            ...
                            <div class="input-group quantity mb-5" style="width: 100px;">
                                ...
                                <input type="text" oninput="this.value= this.value.replace(/[^0-9.,]/g, '').replace(/(\..*)\.,/g, '$1')" class="form-control form-control-sm text-center border-0" value="1" min="1">
                                <div class="input-group-btn">
                            ...
                            <button type="button" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary add-cart" data-id="{{ $record->id }}"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</button>
                        </div>
                        <div class="col-lg-12">
                            <nav>
